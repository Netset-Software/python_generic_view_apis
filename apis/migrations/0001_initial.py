    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sign_up_status', models.CharField(choices=[('sign_up_status_email', 'g_sign_up_status_email'), ('sign_up_status_facebook', 'g_sign_up_status_facebook'), ('sign_up_status_google', 'g_sign_up_status_google')], max_length=64)),
